...
from app.forms import LoginForm, RegistrationForm, UlazRobeForm, IzlazRobeForm, PrviUnosProizvodaForm, UrediProizvodForm, UnosProizvodaForm, SearchForm, EditPasswordForm, UnosTvrtkeForm, SearchFormTvrtka
...
def stanje_skladista(page_num, s):
	...
	if form2.validate_on_submit():
		proizvod = Proizvod(name=form2.name.data, opis_proizvoda=form2.opis_proizvoda.data, kolicina=0)
		db.session.add(proizvod)
		db.session.commit()
